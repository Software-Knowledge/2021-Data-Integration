...
## 5.4. 数据仓库概念模型
![](img/integration/18.png)

## 5.5. 数据仓库的结构
![](img/integration/19.png)
...
### 5.6.1. 切片、切块
![](img/integration/20.png)

### 5.6.2. 钻取
![](img/integration/21.png)

### 5.6.3. 旋转
![](img/integration/22.png)

## 5.7. 数据仓库的体系结构
![](img/integration/23.png)
...
## 5.10. 维表（星型）
![](img/integration/24.png)

## 5.11. 维表（雪花型）
![](img/integration/25.png)
